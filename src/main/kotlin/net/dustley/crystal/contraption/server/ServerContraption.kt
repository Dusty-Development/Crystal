...
class ServerContraption(uuid: UUID, transform: Transform, plot: ScrapyardPlot, contraptionManager: ServerContraptionManager)
    : Contraption(uuid, transform, plot, contraptionManager) {
